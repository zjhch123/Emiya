...
function _testSuccess(filename) {
  const t = '                                                ';
  figlet('^ Emiya >>>', (err, data) => {
    if (err) throw err;
    console.log(`\n${data}`)
    ...
    console.log('┌───────────────────────────────┐'.green);
    console.log(`│         cd ${filename + t.slice(0, 19 - filename.length)}│`.green);
    console.log(`│         sh launch.sh          │`.green);
    console.log(`│         npm run record        │`.green);
    console.log(`│         npm run replay        │`.green);
    console.log(`└───────────────────────────────┘`.green);
  })
}
